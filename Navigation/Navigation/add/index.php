...
<table border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<p><input title="会员卡号" style="width: 170px;" name="smm_number"
			type="text" id="smm_number" value="" size="5" />&nbsp;&nbsp;会员卡号</p>
		<p><input title="会员密码" style="width: 170px;" name="smm_password"
			type="password" id="smm_password" value="" size="5" />&nbsp;&nbsp;会员密码</p>
		</td>
	</tr>
</table>
<p class="line"></p>
<p style="text-align: center;"><input class="btn btn-primary"
	type="submit" name="signupbutton" id="signupbutton" value="添加"
	title="添加" />&nbsp;&nbsp;<a class="btn btn-primary" title="返回"
	href="<?php echo SITE_LINK.'add/'; ?>">返回</a></p>
</form>
</div>
</div>
<div class="span3">&nbsp;</div>
...
<div class="well1">
<form id="formsignup" name="formsignup" method="post" action=""
	class="form-search" style="text-align: center;">
<div class="input-append"><input class="search-query"
	placeholder="例如：编号、名称、地址等" title="在此输入要搜索的内容" style="width: 270px;"
	name="search" type="text" id="search"
	value="<?php echo @$_SESSION["signupuseremail2"]; ?>" size="5" /> <input
	class="btn" type="submit" name="signupbutton" id="signupbutton"
	value="搜索超市" title="搜索超市" /></div>
</form>
