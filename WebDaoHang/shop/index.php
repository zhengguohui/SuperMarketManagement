	...
	<div class="span8">
    	<div class="well">
        	<form id="formsignup" name="formsignup" method="post" action="">
				...
				<p><input title="" style="width:170px;" name="signupuseremail" type="text" id="signupuseremail" value="<?php echo @$_SESSION["signupuseremail"]; ?>" size="5" />&nbsp;&nbsp;邮箱&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;用户类型：&nbsp;&nbsp;<input name="radio" type="radio" id="tag" value="0" checked="checked" />&nbsp;&nbsp;普通用户&nbsp;&nbsp;<input type="radio" name="radio" id="tag2" value="1" />&nbsp;&nbsp;超市用户&nbsp;&nbsp;</p>
				<p><input title="" style="width:170px;" name="signupuserpassword" type="password" id="signupuserpassword" value="<?php echo @$_SESSION["signupuserpassword"]; ?>" size="5" />&nbsp;&nbsp;密码&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;<input title="" style="width:170px;" name="signupreuserpassword" type="password" id="signupreuserpassword" value="<?php echo @$_SESSION["signupreuserpassword"]; ?>" size="5" />&nbsp;&nbsp;密码重复&nbsp;&nbsp;*</p>
                
				<p><input class="btn btn-primary" type="submit" name="signupbutton" id="signupbutton" value="注册" />
    ...
    <div class="span4">
    	<div class="well">
        	<form id="formlogin" name="formlogin" method="post" action="">
				...
				<p><input title="" style="width:170px;" name="loginuseremail" type="text" id="loginuseremail" value="<?php echo @$_SESSION["loginuseremail"]; ?>" size="5" />&nbsp;&nbsp;邮箱&nbsp;&nbsp;*</p>
				<p><input title="" style="width:170px;" name="loginuserpassword" type="password" id="loginuserpassword" value="<?php echo @$_SESSION["loginuserpassword"]; ?>" size="5" />&nbsp;&nbsp;密码&nbsp;&nbsp;*</p>
				<p><input class="btn btn-primary" type="submit" name="buttonlogin" id="buttonlogin" value="登录" />&nbsp;&nbsp;<?php echo Line(); ?><a href="../repassword/">找回密码</a></p>
